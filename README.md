...
firmware/                   드리프터 펌웨어 (ESP32 + GPS + LTE-M) 와 BOM
```
...
대당 저비용을 목표로 한 드리프터입니다. 통신은 통신사 망 대신 사설 저전력망(Meshtastic, KR920 대역)으로 통신비 없이 운영하며, 장거리 구간은 LTE-M으로 확장합니다. 구성은 [firmware/BOM.md](firmware/BOM.md)를 참고하세요.
